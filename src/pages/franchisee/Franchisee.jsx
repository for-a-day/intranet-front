              ...
              <AppBar position="static" sx={{ bgcolor: "rgb(186, 232, 250)", minWidth: 500 }}>
                <Toolbar>
                  <Box sx={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
                    <Typography variant="h3" component="div" sx={{ color: "black", fontWeight: "bold", marginRight: "10px" }}>
                      가맹점 관리
                    </Typography>
                  ...
                  <Button color="inherit" href="/app/franchisee" sx={{color: "black", fontWeight: "bold", backgroundColor: "#59bfcf", margin: "0 5px", borderRadius: "8px",}}>
                  <StoreIcon /> 가맹점
                  </Button>
